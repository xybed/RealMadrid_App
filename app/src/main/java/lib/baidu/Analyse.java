...
public class Analyse {
    ...
    private static void bdtjInit(Context context){
        // 设置AppKey
        //已经在AndroidManifest.xml中生成
     ...
     * 自定义事件统计时长
     */
    public static void onEventDuration(Context context, String event_id, String label, int duration){
        StatService.onEventDuration(context, event_id, label, duration);
    }
}
